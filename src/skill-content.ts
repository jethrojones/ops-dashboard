// The "ops-add-script" skill — a Markdown file embedded as a string so it can
// be downloaded by users without a separate server endpoint. Drop the
// contents into ~/.claude/skills/ops-add-script/SKILL.md (or use the
// project-local copy in .claude/skills/ops-add-script/).

export const ADD_SCRIPT_SKILL_MD: string = `---
name: ops-add-script
